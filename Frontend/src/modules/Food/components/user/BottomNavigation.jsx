    ...
    >
      ...
      >
        ...
        <div className="text-left leading-none">
          <span className="block text-[8px] font-black uppercase tracking-[0.2em] text-[#cc2532]">
            Explore
          </span>
        </div>
        <div className="flex h-6 w-6 items-center justify-center rounded-[8px] bg-red-50 text-[#cc2532]">
      ...
      <div className="flex items-center justify-around h-auto px-2 sm:px-4">
        ...
        >
          < Truck className={`h-5 w-5 ${isDelivery ? "text-[#cc2532] dark:text-red-500 fill-[#cc2532] dark:fill-red-500" : "text-gray-600 dark:text-gray-400"}`} strokeWidth={2} />
          <span className={`text-xs sm:text-sm font-medium ${isDelivery ? "text-[#cc2532] dark:text-red-500 font-semibold" : "text-gray-600 dark:text-gray-400"}`}>
            Delivery
          </span>
          {isDelivery && (
            <div className="absolute top-0 left-0 right-0 h-0.5 bg-[#cc2532] dark:bg-red-500 rounded-b-full" />
          )}
        </Link>
        ...
        >
          <UtensilsCrossed className={`h-5 w-5 ${isDining ? "text-[#cc2532] dark:text-red-500" : "text-gray-600 dark:text-gray-400"}`} strokeWidth={2} />
          <span className={`text-xs sm:text-sm font-medium ${isDining ? "text-[#cc2532] dark:text-red-500 font-semibold" : "text-gray-600 dark:text-gray-400"}`}>
            Dining
          </span>
          {isDining && (
            <div className="absolute top-0 left-0 right-0 h-0.5 bg-[#cc2532] dark:bg-red-500 rounded-b-full" />
        ...
        >
          <Tag className={`h-5 w-5 ${isUnder250 ? "text-[#cc2532] dark:text-red-500 fill-[#cc2532] dark:fill-red-500" : "text-gray-600 dark:text-gray-400"}`} strokeWidth={2} />
          <span className={`text-xs sm:text-sm font-medium ${isUnder250 ? "text-[#cc2532] dark:text-red-500 font-semibold" : "text-gray-600 dark:text-gray-400"}`}>
            Under 250
          </span>
          {isUnder250 && (
            <div className="absolute top-0 left-0 right-0 h-0.5 bg-[#cc2532] dark:bg-red-500 rounded-b-full" />
        ...
        >
          <User className={`h-5 w-5 ${isProfile ? "text-[#cc2532] dark:text-red-500 fill-[#cc2532] dark:fill-red-500" : "text-gray-600 dark:text-gray-400"}`} />
          <span className={`text-xs sm:text-sm font-medium ${isProfile ? "text-[#cc2532] dark:text-red-500 font-semibold" : "text-gray-600 dark:text-gray-400"}`}>
            Profile
          </span>
          {isProfile && (
            <div className="absolute top-0 left-0 right-0 h-0.5 bg-[#cc2532] dark:bg-red-500 rounded-b-full" />
